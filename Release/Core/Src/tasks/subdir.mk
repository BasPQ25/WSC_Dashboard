...
clean-Core-2f-Src-2f-tasks:
	-$(RM) ./Core/Src/tasks/Software_config.cyclo ./Core/Src/tasks/Software_config.d ./Core/Src/tasks/Software_config.o ./Core/Src/tasks/Software_config.su ./Core/Src/tasks/buttons.cyclo ./Core/Src/tasks/buttons.d ./Core/Src/tasks/buttons.o ./Core/Src/tasks/buttons.su ./Core/Src/tasks/can_receive.cyclo ./Core/Src/tasks/can_receive.d ./Core/Src/tasks/can_receive.o ./Core/Src/tasks/can_receive.su ./Core/Src/tasks/can_transmit.cyclo ./Core/Src/tasks/can_transmit.d ./Core/Src/tasks/can_transmit.o ./Core/Src/tasks/can_transmit.su ./Core/Src/tasks/display.cyclo ./Core/Src/tasks/display.d ./Core/Src/tasks/display.o ./Core/Src/tasks/display.su
