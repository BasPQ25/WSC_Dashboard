...
HAL_StatusTypeDef HAL_ADCEx_Calibration_Start(struct __ADC_HandleTypeDef *hadc,
		uint32_t SingleDiff);
uint32_t HAL_ADCEx_Calibration_GetValue(struct __ADC_HandleTypeDef *hadc,
		uint32_t SingleDiff);
HAL_StatusTypeDef HAL_ADCEx_Calibration_SetValue(
		struct __ADC_HandleTypeDef *hadc, uint32_t SingleDiff,
...
HAL_StatusTypeDef HAL_ADCEx_InjectedPollForConversion(
		struct __ADC_HandleTypeDef *hadc, uint32_t Timeout);
...
HAL_StatusTypeDef HAL_ADCEx_InjectedStop_IT(struct __ADC_HandleTypeDef *hadc);
    ...
    defined(STM32F301x8) || defined(STM32F302x8) || defined(STM32F318xx)
/* ADC multimode */
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(struct __ADC_HandleTypeDef *hadc,
...
uint32_t HAL_ADCEx_InjectedGetValue(struct __ADC_HandleTypeDef *hadc,
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(
		struct __ADC_HandleTypeDef *hadc, ADC_MultiModeTypeDef *multimode);
#endif /* STM32F302xE || STM32F303xE || STM32F398xx || */
/* STM32F302xC || STM32F303xC || STM32F358xx || */
/* STM32F303x8 || STM32F334x8 || STM32F328xx || */
/* STM32F301x8 || STM32F302x8 || STM32F318xx    */
